  ...
  <div className="pt-32 px-6 max-w-5xl mx-auto space-y-20 pb-20">
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-5xl md:text-6xl font-black text-text-primary tracking-tighter">Cybersecurity & Pentesting</h1>
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="glass-card p-8 border-t-2 border-sky-500/30">
        ...
        <h3 className="text-2xl font-bold mb-3 text-text-primary tracking-tight">OSINT</h3>
        <p className="text-text-muted text-sm leading-relaxed">Open Source Intelligence: gathering information from public sources to map the attack surface and identify potential entry points.</p>
      </div>
      <div className="glass-card p-8 border-t-2 border-emerald-500/30">
        <Lock className="text-emerald-400 mb-6" size={32} />
        <h3 className="text-2xl font-bold mb-3 text-text-primary tracking-tight">Cryptography</h3>
        <p className="text-text-muted text-sm leading-relaxed">The study of secure communication techniques, ensuring data confidentiality, integrity, and authenticity through advanced algorithms.</p>
      </div>
      <div className="glass-card p-8 border-t-2 border-purple-500/30">
        <Terminal className="text-purple-400 mb-6" size={32} />
        <h3 className="text-2xl font-bold mb-3 text-text-primary tracking-tight">Exploitation</h3>
        <p className="text-text-muted text-sm leading-relaxed">Identifying and leveraging software vulnerabilities to demonstrate critical security flaws and assess potential impact.</p>
      </div>
    </div>
        ...
        <div className="flex-1 space-y-8">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <li key={item} className="flex items-center gap-3 text-text-muted text-sm font-medium">
    ...
    <section className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="glass-card p-10 group hover:border-sky-500/20 transition-all">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h3 className="text-2xl font-bold text-text-primary tracking-tight">Anonsurf</h3>
          </div>
          ...
          <div className="bg-slate-950 p-6 rounded-2xl font-mono text-xs text-emerald-500 border border-border-subtle shadow-inner">
        ...
        <div className="glass-card p-10 group hover:border-sky-500/20 transition-all">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h3 className="text-2xl font-bold text-text-primary tracking-tight">Nmap</h3>
          </div>
          <p className="text-text-secondary mb-6 text-sm leading-relaxed font-medium">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <div key={idx} className="glass-card p-8 hover:bg-bg-card transition-all border-border-subtle">
            <tool.icon className="text-sky-400 mb-6" size={28} />
            <h4 className="font-bold text-text-primary text-lg mb-3 tracking-tight">{tool.title}</h4>
            <p className="text-text-muted text-xs leading-relaxed font-medium">{tool.desc}</p>
          </div>
        ))}
      </div>
    </section>
    ...
    <section className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        <div className="space-y-6">
          <h3 className="text-2xl font-bold text-text-primary tracking-tight">1. Installation</h3>
        ...
        <div className="space-y-6">
          <h3 className="text-2xl font-bold text-text-primary tracking-tight">2. System Update</h3>
          <p className="text-text-secondary text-base leading-relaxed font-medium">
            Once installed, open the terminal and ensure everything is updated to the latest stable version.
          </p>
          <div className="bg-slate-950 p-6 rounded-2xl font-mono text-xs text-sky-400 border border-border-subtle shadow-inner">
            <p className="font-bold">sudo apt update && sudo apt full-upgrade</p>
          </div>
        </div>
        <div className="space-y-6">
          <h3 className="text-2xl font-bold text-text-primary tracking-tight">3. Privacy Config</h3>
          <p className="text-text-secondary text-base leading-relaxed font-medium">
            Activate Anonsurf to protect your browsing and use the default browser pre-configured with security extensions.
          </p>
        </div>
        <div className="space-y-6">
          <h3 className="text-2xl font-bold text-text-primary tracking-tight">4. Explore the Tools</h3>
          <p className="text-text-secondary text-base leading-relaxed font-medium">
        ...
        {[
          ...
          <div key={i} className="glass-card p-8 border-l-4 border-red-500/20 hover:bg-red-500/[0.02] transition-all">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h4 className="text-xl font-bold text-text-primary">{attack.title}</h4>
            </div>
            <p className="text-sm text-text-muted leading-relaxed">{attack.desc}</p>
          </div>
        ))}
      </div>
    </section>
